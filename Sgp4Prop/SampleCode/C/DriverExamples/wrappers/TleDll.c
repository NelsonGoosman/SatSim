...
void FreeTleDll()
{
   ...
   TleSaveFile = NULL;
   TleRemoveSat = NULL;
   TleRemoveAllSats = NULL;
   TleGetCount = NULL;
   TleGetLoaded = NULL;
   TleAddSatFrLines = NULL;
   TleAddSatFrLinesML = NULL;
   TleAddSatFrCsv = NULL;
   TleAddSatFrCsvML = NULL;
   TleAddSatFrFieldsGP = NULL;
   TleAddSatFrFieldsGP2 = NULL;
   TleAddSatFrFieldsGP2ML = NULL;
   TleUpdateSatFrFieldsGP = NULL;
   TleUpdateSatFrFieldsGP2 = NULL;
   TleAddSatFrFieldsSP = NULL;
   TleAddSatFrFieldsSPML = NULL;
   TleUpdateSatFrFieldsSP = NULL;
   TleSetField = NULL;
   TleGetField = NULL;
   TleGetAllFieldsGP = NULL;
   TleGetAllFieldsGP2 = NULL;
   TleGetAllFieldsSP = NULL;
   TleParseGP = NULL;
   TleLinesToArray = NULL;
   TleParseSP = NULL;
   TleGetLines = NULL;
   TleGetCsv = NULL;
   TleGPFieldsToLines = NULL;
   TleGPFieldsToCsv = NULL;
   TleGPArrayToLines = NULL;
   TleGPArrayToCsv = NULL;
   TleSPFieldsToLines = NULL;
   TleGetSatKey = NULL;
   TleGetSatKeyML = NULL;
   TleFieldsToSatKey = NULL;
   TleFieldsToSatKeyML = NULL;
   TleAddSatFrArray = NULL;
   TleAddSatFrArrayML = NULL;
   TleUpdateSatFrArray = NULL;
   TleDataToArray = NULL;
   TleLinesToCsv = NULL;
   TleCsvToLines = NULL;
   SetTleKeyMode = NULL;
