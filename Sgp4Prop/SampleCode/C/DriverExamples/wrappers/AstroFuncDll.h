...
typedef void (STDCALL *fnPtrTemeEpochToDate)(int nutationTerms, double epochDs50TAI, double dateDs50TAI, double posEpoch[3], double velEpoch[3], double posDate[3], double velDate[3]);
...
// posECI             The resulting ECI (TEME of Date) position vector (km). (out-Double[3])
// velECI             The resulting ECI (TEME of Date) velocity vector (km/s). (out-Double[3])
typedef void (STDCALL *fnPtrECRToECITime)(double ds50UTC, double posECR[3], double velECR[3], double posECI[3], double velECI[3]);
...
// posECR             The resulting ECR position vector (km). (out-Double[3])
// velECR             The resulting ECR velocity vector (km/s). (out-Double[3])
typedef void (STDCALL *fnPtrECIToECRTime)(double ds50UTC, double posECI[3], double velECI[3], double posECR[3], double velECR[3]);
...
typedef void (STDCALL *fnPtrECRToJ2KTime)(int spectr, int nutationTerms, double ds50UTC, double posECR[3], double velECR[3], double posJ2K[3], double velJ2K[3]);
...
// posECR             The resulting ECR position vector (km). (out-Double[3])
// velECR             The resulting ECR velocity vector (km/s). (out-Double[3])
typedef void (STDCALL *fnPtrJ2KToECRTime)(int spectr, int nutationTerms, double ds50UTC, double posJ2K[3], double velJ2K[3], double posECR[3], double velECR[3]);
...
extern fnPtrTemeEpochToDate                TemeEpochToDate;
extern fnPtrECRToECITime                   ECRToECITime;
extern fnPtrECIToECRTime                   ECIToECRTime;
extern fnPtrECRToJ2KTime                   ECRToJ2KTime;
extern fnPtrJ2KToECRTime                   J2KToECRTime;
