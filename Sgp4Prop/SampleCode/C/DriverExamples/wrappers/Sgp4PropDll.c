...
fnPtrXpGetNativeElts                XpGetNativeElts;
fnPtrXpReepochGetNativeElts         XpReepochGetNativeElts;
...
void LoadSgp4PropDll()
{
   ...
   XpGetNativeElts = (fnPtrXpGetNativeElts)GetFnPtr(hLib, (char*)"XpGetNativeElts");
   XpReepochGetNativeElts = (fnPtrXpReepochGetNativeElts)GetFnPtr(hLib, (char*)"XpReepochGetNativeElts");
}
...
void FreeSgp4PropDll()
{
   ...
   Sgp4Init = NULL;
   Sgp4GetInfo = NULL;
   Sgp4LoadFileAll = NULL;
   Sgp4SaveFile = NULL;
   Sgp4InitSat = NULL;
   Sgp4RemoveSat = NULL;
   Sgp4RemoveAllSats = NULL;
   Sgp4GetCount = NULL;
   Sgp4PropMse = NULL;
   Sgp4PropDs50UTC = NULL;
   Sgp4PropDs50UtcPosVel = NULL;
   Sgp4PropDs50UtcLLH = NULL;
   Sgp4PropDs50UtcPos = NULL;
   Sgp4GetPropOut = NULL;
   Sgp4PropAll = NULL;
   Sgp4PosVelToKep = NULL;
   Sgp4PosVelToTleArr = NULL;
   Sgp4ReepochTLE = NULL;
   Sgp4ReepochCsv = NULL;
   Sgp4SetLicFilePath = NULL;
   Sgp4GetLicFilePath = NULL;
   Sgp4GenEphems = NULL;
   Sgp4GenEphems_OS = NULL;
   Sgp4PropAllSats = NULL;
   XpGetNativeElts = NULL;
   XpReepochGetNativeElts = NULL;
}
