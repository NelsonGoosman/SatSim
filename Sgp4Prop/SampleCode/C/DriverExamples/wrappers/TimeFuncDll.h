...
typedef int (STDCALL *fnPtrTimeFuncInit)(__int64 apAddr);
...
// returns 1 if timing constants data have been loaded, 0 if not.
...
typedef void (STDCALL *fnPtrUTCToDTG)(double ds50UTC, int dtgFmt, char outDtg[32]);
...
// returns The number of days since 1950, UTC. Partial days may be returned.
typedef double (STDCALL *fnPtrDTGToUTCExt)(char dtg[32]);
...
// ds50UTC            Days since 1950, UTC to be converted. (in-Double)
// returns The number of days since 1950, ET (Ephemeris Time/Terrestrial Time). Partial days may be returned.
...
typedef double (STDCALL *fnPtrThetaGrnwch)(double ds50UT1, __int64 lenvFk);
...
typedef void (STDCALL *fnPtrTConTimeSpan)(int* numOfRecs, double* frTimeDs50UTC, double* toTimeDs50UTC);
...
extern fnPtrUTCToDTG                       UTCToDTG;
extern fnPtrDTGToUTC                       DTGToUTC;
extern fnPtrDTGToUTCExt                    DTGToUTCExt;
...
extern fnPtrTConTimeSpan                   TConTimeSpan;
